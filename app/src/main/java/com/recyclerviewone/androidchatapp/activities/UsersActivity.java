...
import com.recyclerviewone.androidchatapp.adapters.UserAdapter;
import com.recyclerviewone.androidchatapp.databinding.ActivityUsersBinding;
import com.recyclerviewone.androidchatapp.listeners.UserListener;
...
public class UsersActivity extends AppCompatActivity implements UserListener {
    ...
    public void onUserClicked(User user) {
        ...
        //        i.putExtra(Constants.KEY_USER, user.name);
        startActivity(i);
        finish();
