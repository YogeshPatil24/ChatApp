...
import com.recyclerviewone.androidchatapp.databinding.ActivitySignUpBinding;
...
public class SignUpctivity extends AppCompatActivity {
    ...
    private void setListeners() {
        binding.textSignIn.setOnClickListener(view -> startActivity(new Intent(getApplicationContext(), SignInActivity.class)));
